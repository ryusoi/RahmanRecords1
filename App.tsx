    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end">
      {isOpen && (
        <div className="mb-4 w-[350px] sm:w-[400px] bg-[#1a1a1a] rounded-t-xl rounded-bl-xl shadow-[0_0_40px_rgba(0,0,0,0.8)] border border-gold-dark/40 overflow-hidden flex flex-col h-[600px] animate-float backdrop-blur-xl">
          <div className="bg-gradient-to-r from-black to-[#1a1a1a] p-4 flex flex-col justify-between border-b border-gold-dark/20 relative">
            
            {/* Dynamic Visual Spectrum Analyzer in Header */}
            <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none">
                <VisualSpectrum barCount={30} height="100%" />
            </div>
      ...
      default:
        return (
          <>
            ...
            {/* New Embedded Video Section - Midway Below Shop */}
            <div className="w-full relative z-10 border-t border-white/5">
                <ParallaxSection videoUrl="https://wafisohswxqutsttotkb.supabase.co/storage/v1/object/public/Tek/Tehran%20Records.mp4" height="h-[60vh]">
                    <div className="bg-black/40 backdrop-blur-md p-8 rounded-2xl border border-gold-dark/30 animate-in fade-in zoom-in duration-700 flex flex-col items-center">
                        <WordShine 
                            text={t('mid_banner.title')} 
                            isTitle={true} 
                            className="text-4xl md:text-6xl font-robotica font-bold mb-4" 
                        />
                        <WordShine 
                            text={t('mid_banner.subtitle')} 
                            isTitle={false} 
            ...
            {/* NEW: Full Width Tehran Records Video Section */}
            <div className="w-full relative bg-black border-t border-gold-dark/30">
               <video 
                 src="https://wafisohswxqutsttotkb.supabase.co/storage/v1/object/public/Tek/Tehran%20Records.mp4"
            ...
            {/* Aurora Animation at Bottom of Home Page */}
            <div className="relative h-[60vh] w-full overflow-hidden border-t border-gold-dark/30">
               <AuroraBackground />
               <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                  <h2 className="text-4xl md:text-6xl font-light text-white mb-6 leading-tight">
                      Experience the <span className="aurora-text font-medium">Future of Analog</span>
                  </h2>
               </div>
            </div>
          </>
